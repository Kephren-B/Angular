...
export class CharacterService {
	...
	getMany(ids: number[]): Observable<Character[]> {
		// L'API accepte /api/character/1,2,3 ou /api/character/[1,2,3]
		// Si un seul ID est passé dans le tableau, l'API renvoie un objet au lieu d'un tableau.
		// RxJS ou un map permettrait de normaliser cela si besoin.
